...
equation \ref{eq:Psi}. Since we will in actuality not be
using an infinite amount of terms for our series, the notation
$\vb{\hat{B}}$ will be used for our estimated $\vb{B}$ field.
The $B_z$ component will then be
\begin{equation}
    \begin{split}
        \hat{B}_z &= \frac{\partial \Psi}{\partial z} =
        \Cnk[0,0] + \Bffzok +\\
        &+ \Bffznk
    \end{split}
\end{equation}
...
\begin{equation}
    \begin{split}
        \hat{B}_r &= \frac{\partial \Psi}{\partial r} =
